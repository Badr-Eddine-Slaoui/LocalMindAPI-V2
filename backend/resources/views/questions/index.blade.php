        ...
        <div class="flex-1 max-w-[800px]">
            ...
            <div class="mb-6 border-b border-white/5">
                <div class="flex gap-8 overflow-x-auto no-scrollbar">
                    <a class="flex flex-col items-center justify-center border-b-[3px] border-primary text-primary pb-3 transition-colors"
                        href="{{ route('home') }}">
            ...
            <aside class="hidden xl:flex flex-col w-64 gap-6 shrink-0">
                    ...
                    <div class="pt-8 px-5 pb-5">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div class="text-center p-2 bg-white/5 rounded-lg border border-white/5">
                                <span class="block text-primary font-bold text-lg">{{ auth()->user()->favorites->count() }}</span>
                                <span class="text-[10px] text-white/40 font-bold uppercase">Favorites</span>
                            </div>
                            <div class="text-center p-2 bg-white/5 rounded-lg border border-white/5">
                                <span class="block text-primary font-bold text-lg">{{ auth()->user()->questions->count() }}</span>
                ...
                @if (auth()->user()->role === 'admin')
                    <div class="bg-sidebar-black p-5 rounded-xl border border-white/5">
                        ...
                        <a class="inline-flex items-center gap-2 text-primary font-bold text-sm hover:underline" href="{{ route('admin') }}">
                            Moderator Dashboard
