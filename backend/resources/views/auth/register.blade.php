    ...
    <main class="flex-1 flex items-center justify-center p-6 sm:p-12 relative overflow-hidden">
        ...
        <div class="w-full max-w-[500px] z-10">
            <div class="scroll-card charred-edge p-8 sm:p-12 rounded-2xl relative overflow-hidden">
                ...
                <form action="{{ route('submitRegister') }}" method="POST" class="space-y-5">
                    @csrf
                    <div class="flex flex-col gap-1.5">
                        ...
                        <div class="relative">
                            <input
                                ...
                                placeholder="Monkey D. Luffy" required="" type="text" name="name" value="{{ old('name') }}" />
                            <span
                    ...
                    <div class="flex flex-col gap-1.5">
                        <label class="text-gray-400 text-xs font-bold uppercase tracking-widest ml-1">Snail Frequency
                            (Email)</label>
                        <div class="relative">
                            <input
                                class="glow-input w-full rounded-lg h-14 pl-12 pr-4 text-white placeholder:text-gray-600 focus:ring-0"
                                placeholder="captain@sunny.go" required="" type="email" name="email" value="{{ old('email') }}" />
                            <span
                    ...
                    <div class="flex flex-col gap-1.5">
                        ...
                        <div class="relative">
                            <input
                                class="glow-input w-full rounded-lg h-14 pl-12 pr-4 text-white placeholder:text-gray-600 focus:ring-0"
                                placeholder="••••••••" required="" type="password" name="password" value="{{ old('password') }}" />
                            <span
                    ...
                    <div class="flex flex-col gap-1.5">
                        ...
                        <div class="relative">
                            <input
                                class="glow-input w-full rounded-lg h-14 pl-12 pr-4 text-white placeholder:text-gray-600 focus:ring-0"
                                placeholder="••••••••" required="" type="password" name="password_confirmation" value="{{ old('password_confirmation') }}" />
                            <span
                ...
                <div class="mt-8 text-center border-t border-cyan-900/30 pt-6">
                    <p class="text-gray-400 text-sm">
                        Already in the crew?
                        <a class="text-primary font-bold hover:neon-text-blue transition-all" href="{{ route('login') }}">Return to
                            Ship</a>
                    </p>
                </div>
            </div>
