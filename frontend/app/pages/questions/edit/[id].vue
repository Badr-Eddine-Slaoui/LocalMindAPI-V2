<script setup lang="ts">
    ...
    onMounted(async() => {
        ...
        form.title = store.question?.title as string
        form.description = store.question?.description as string
        if(!auth.user) {
    ...
    const submit = async() => {
        const res: ReturnData<any> = await store.updateQuestion(id, (form));
