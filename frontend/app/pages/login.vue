        ...
        <main class="flex-1 flex items-center justify-center p-6 z-10">
            <div class="w-full max-w-[480px] flex flex-col gap-2">
                <div class="text-center mb-6">
                    <h1 class="text-white tracking-tight text-[36px] font-extrabold leading-tight pb-2">
                        Welcome Back, Nakama!
                    </h1>
                    <p class="text-slate-400 text-base font-normal leading-normal">
                        The stars guide your path to wisdom.
                    </p>
                </div>
                <div class="glass-card rounded-2xl shadow-2xl overflow-hidden p-10">
                    <form @submit.prevent="submit" method="POST" class="flex flex-col gap-6">
                        <div class="flex flex-col gap-2">
                            ...
                            <div class="relative">
                                ...
                                <input
                                    ...
                                    placeholder="luffy@thousandsunny.com" type="email" v-model="form.email" />
                            </div>
                            <span v-if="errs.email" class="text-red-500 text-xs mt-1">{{
                                errs.email
                                }}</span>
                        </div>
                        <div class="flex flex-col gap-2">
                            ...
                            <span v-if="errs.password" class="text-red-500 text-xs mt-1">{{
                                errs.password
                                }}</span>
                        </div>
                        <div class="flex items-center justify-between">
                            <label class="flex items-center gap-3 cursor-pointer group">
                                <div class="relative flex items-center">
                                    <input name="remember" v-model="form.remember"
                                ...
                                <span
                                    class="text-sm text-slate-400 ml-6 group-hover:text-silver-mist transition-colors">Stay
                                    aboard for 30 days</span>
                            </label>
                        </div>
                        <span v-if="errs.login" class="text-red-500 text-xs mt-1">{{
                            errs.login
                            }}</span>
                        <button
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <button
                            ...
                            <div class="w-5 h-5 bg-center bg-contain bg-no-repeat" style="
                    background-image: url(&quot;https://lh3.googleusercontent.com/aida-public/AB6AXuB_o-ukkpICbT4KYX4QiFMjsi4b1NMX0z4fLGLZnPfgUlR_ezzLaW0vIxQDIU0RCivoGbF71NmrGtcSTTaGGo0S0tjbZJu60oE3fQRAJfvKGhgCQjEBQkQNpHACFqqLDJnhGv69lNifu4U6TLGpKOvF3-yjJ5zOGwM-f5_shtgXDzkzEkjOaVc53PGlcVohm8f_vBeltFTrRkSuWjQtPTrItsiJ4qiwT1ngGGP9kfayWRNuwbs_G6NeI6LhfMGbT9a8B3oSzuS5Knw&quot;);
                "></div>
                        ...
                        <button
                            class="flex items-center justify-center gap-2 h-12 rounded-lg border border-white/10 bg-white/5 hover:bg-white/10 hover:border-white/20 transition-all">
                            <div class="w-5 h-5 bg-center bg-contain bg-no-repeat" style="
                    background-image: url(&quot;https://lh3.googleusercontent.com/aida-public/AB6AXuBYsh5eTWHjx6Y9ymgDHnEixSdCW8A5RFRSHHTyR-P6zq1f-a7xMIQAUdM6hQzMVxn8HZiLmgB0KCjjfGzGmtGlZJ_Afxohsx0djvElSIUlyUHAQLndjuzWXFOa1CH0WlfQODJ_ukzEEvAQdI3bfsqn73Ygafy8sr9J9b1TCQwuHvHZb1kxGGTx_UgJp0ezzMfuEA_1hZDUFr3n6fPUMaJrKEuqujovg3glhzBrIcreME3WThzfDqp7XvQsAWg0qAb6DGPVxPDNT0Q&quot;);
                "></div>
                ...
                <div class="mt-8 flex flex-col items-center gap-4">
                    <p class="text-sm text-slate-500">
                        ...
                        <NuxtLink to="/register" class="text-pirate-gold font-bold hover:underline ml-1">Join the Crew
                        </NuxtLink>
                    </p>
